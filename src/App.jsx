    ...
    <>
      ...
      <section className="baground" id="index">
        ...
        <div className="text-overlay">
          ...
          <button type="button" aria-label="Submit Form">Enter</button>
        </div>
      </section>
      ...
      <section className="cards-container">
        <div className="card">
          <img src="https://img.freepik.com/photos-premium/illustration-3d-avatar-du-profil-personnage-dessin-anime_1183071-136.jpg" alt="description text" loading="lazy" />
        ...
        <div className="card">
          <img src="https://i.pinimg.com/736x/62/28/c7/6228c71efa95b0be867a3a955beed6d0.jpg" alt="description text" loading="lazy" />
          <div className="card-content">
        ...
        <div className="card">
          <img src="https://i.pinimg.com/originals/b3/1e/87/b31e876ac1381404535b3a7287bf9605.png" alt="description text" loading="lazy" />
          <div className="card-content">
        ...
        <div className="card">
          <img src="https://3.bp.blogspot.com/-Y096u66r_U8/WHQebMbvCXI/AAAAAAAAEjU/tqCfSi0FZOApfOFMFr1tmwwLv4-NyO_eACLcB/s1600/myAvatar.png" alt="description text" loading="lazy" />
          <div className="card-content">
      ...
      <img src="https://www.a2hosting.com/blog/content/uploads/2021/01/Website-Design.jpg" alt="des text" />        
